...
(function () {
  ...
  const css = `
  .install-tip{position:fixed;left:50%;transform:translateX(-50%);bottom:calc(72px + env(safe-area-inset-bottom));width:calc(100% - 24px);max-width:456px;background:#1E2320;color:#F3F1EC;border-radius:14px;padding:14px 14px 12px;box-shadow:0 12px 40px rgba(0,0,0,.28);z-index:30;font-family:inherit;font-size:14px;line-height:1.45}
  ...
  .install-tip .go{background:#2F6B4F;color:#fff}
  .install-tip .no{background:rgba(255,255,255,.12);color:#F3F1EC}
  .install-tip .x{position:absolute;top:6px;right:8px;background:none;color:#9AA097;font-size:20px;width:32px;flex:none;padding:0}
